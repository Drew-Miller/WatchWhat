...
public extension WatchWhatSchema {
  class MoviesByGenreQuery: GraphQLQuery {
    public static let operationName: String = "MoviesByGenre"
    public static let document: ApolloAPI.DocumentType = .notPersisted(
      definition: .init(
        #"""
        query MoviesByGenre($genreIds: [Int], $page: Int) {
          moviesByGenre(genreIds: $genreIds, page: $page) {
            __typename
            page
            total_pages
            total_results
    ...
    public struct Data: WatchWhatSchema.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("moviesByGenre", MoviesByGenre.self, arguments: [
          "genreIds": .variable("genreIds"),
          "page": .variable("page")
        ]),
      ] }

      public var moviesByGenre: MoviesByGenre { __data["moviesByGenre"] }

      /// MoviesByGenre
      ///
      /// Parent Type: `PaginatedMovies`
      public struct MoviesByGenre: WatchWhatSchema.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
