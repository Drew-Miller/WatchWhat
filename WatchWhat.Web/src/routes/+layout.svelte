<script lang="ts">
	...
	let selectedCategory = movieCategories[0];
</script>

<header class="sticky top-0 bg-white p-4 shadow-md z-10 transition-opacity opacity-100">
	<!-- Header content (User icon and search icon) -->
	<div class="flex items-center justify-between">
		<div>
			<!-- Replace 'User Icon' with your user icon component -->
			<span>User Icon</span>
		</div>
		<div>
			<!-- Replace 'Search Icon' with your search icon component -->
...
<div class="flex h-screen">
	<nav class="w-64 bg-gray-800 p-4 text-white">
		<!-- Sidebar content -->
		<h2 class="text-lg font-bold mb-4">Main Site Navigation</h2>
		<ul class="space-y-2">
			<li>
				<a href="#" class="block text-blue-400 hover:text-blue-500">Home</a>
			</li>
			<li>
				<a href="#" class="block text-blue-400 hover:text-blue-500">Trending</a>
			</li>
			<li>
				<a href="#" class="block text-blue-400 hover:text-blue-500">Popular</a>
			</li>
			<li>
				<a href="#" class="block text-blue-400 hover:text-blue-500">Discover</a>
			</li>
		</ul>
