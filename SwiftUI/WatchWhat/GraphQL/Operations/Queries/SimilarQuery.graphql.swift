  ...
  class SimilarQuery: GraphQLQuery {
    ...
    public struct Data: WatchWhatSchema.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("similar", Similar.self, arguments: ["id": .variable("id")]),
      ] }
      ...
      /// Similar
      ///
      /// Parent Type: `PaginatedSimilar`
      public struct Similar: WatchWhatSchema.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }

        public static var __parentType: ApolloAPI.ParentType { WatchWhatSchema.Objects.PaginatedSimilar }
        public static var __selections: [ApolloAPI.Selection] { [
        ...
        public struct Result: WatchWhatSchema.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { WatchWhatSchema.Objects.Similar }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("id", Int.self),
